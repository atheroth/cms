...
@section('content')
    <form action="">
        ...
        <div class="mb-2">
            ...
            <textarea class="form-control" id="content" rows="3" placeholder="Содержание статьи"></textarea>
        </div>

        <div class="mb-2">
            <h5><label class="form-label">Изображение</label></h5>
            <input type="text" class="form-control" id="image" placeholder="Ссылка на картинку">
        </div>

        <div class="mb-2">
            <h5><label class="form-label">Лайки</label></h5>
            <input type="text" class="form-control" id="likes" placeholder="Количество лайков">
        </div>
